...
namespace AccelByte.Api
{
    ...
    public class Lobby
    {
        ...
        /// </summary>
        public event ResultCallback<MessageNotification> OnNotification;
        
        /// <summary>
        /// Raised when friends status changed 
        /// </summary>
        public event ResultCallback<UserStatusNotif> UserStatusNotification;
        
        /// <summary>
        /// Raised when friend request accepted
        /// </summary>        
        public event ResultCallback<AcceptFriendsNotif> OnFriendRequestAccepted;
        
        /// <summary>
        /// Raised when there is an incoming friend request
        /// </summary>
        public event ResultCallback<RequestFriendsNotif> OnIncomingFriendRequest;
        
        /// <summary>
        /// Raised when matchmaking process is completed.
        /// </summary>
        public event ResultCallback<MatchmakingNotif> MatchmakingNotification;
        ...
        public void Connect()
        {
            ...
            this.Connected = true;
            this.taskDispatcher.Start(this.Ping());
        }
        ...
        {
            this.SendRequest(MessageType.partyInfoRequest, callback);
        }
        ...
        {
            this.SendRequest(MessageType.partyCreateRequest, callback);
        }
        ...
        {
            this.SendRequest(MessageType.partyLeaveRequest, callback);
        }
        ...
        {
            this.SendRequest(MessageType.partyInviteRequest, new PartyInviteRequest {friendID = userId}, callback);
        }
        ...
        {
            this.SendRequest(MessageType.partyJoinRequest,
        ...
        {
            this.SendRequest(MessageType.partyKickRequest, new PartyKickRequest {memberID = userId}, callback);
        }
        ...
        {
            this.SendRequest(MessageType.partyChatRequest, new PartyChatRequest {payload = chatMessage}, callback);
        }
        ...
        {
            this.SendRequest(MessageType.personalChatRequest,
        ...
        {
            this.SendRequest(MessageType.friendsStatusRequest, callback);
        }
        
        /// <summary>
        ///  Ask lobby to send all pending notification to user. Listen to OnNotification.
        /// </summary> 
        public void PullAsyncNotifications()
        {
            this.SendRequest(MessageType.offlineNotificationRequest, null);
        }
        ...
        {
            this.SendRequest(MessageType.requestFriendsRequest, new TargetedUserId { friendId = userId }, callback);
        }
        ...
        {
            this.SendRequest(MessageType.unfriendRequest, new TargetedUserId { friendId = userId }, callback);
        }

        /// <summary>
        /// Send list of outgoing friends request.
        /// </summary>
        /// <param name="callback">Result of the function with an array of user ID.</param>
        public void ListOutgoingFriends(ResultCallback<ListOutgoingFriends> callback)
        {
            this.SendRequest(MessageType.listOutgoingFriendsRequest, callback);
        }
        ...
        {
            this.SendRequest(MessageType.cancelFriendsRequest, new TargetedUserId { friendId = userId }, callback);
        }
        ...
        /// </summary>
        /// <param name="callback">Result of the function with an array of user ID.</param>
        public void ListIncomingFriends(ResultCallback<ListIncomingFriends> callback)
        {
            this.SendRequest(MessageType.listIncomingFriendsRequest, callback);
        }
        ...
        {
            this.SendRequest(MessageType.acceptFriendsRequest, new TargetedUserId { friendId = userId }, callback);
        }
        ...
        {
            this.SendRequest(MessageType.rejectFriendsRequest, new TargetedUserId { friendId = userId }, callback);
        }
        ...
        /// </summary>
        /// <param name="callback">Result of the function with an array of user ID.</param>
        public void LoadFriendsList(ResultCallback<FriendList> callback)
        {
            this.SendRequest(MessageType.listOfFriendsRequest, callback);
        }
        ...
        /// </summary>
        /// <param name="userId">Targeted user ID.</param>
        /// <param name="callback">Result of the function with an enum of relationship status code.</param>
        public void GetFriendshipStatus(string userId, ResultCallback<FriendshipStatus> callback)
        {
            this.SendRequest(MessageType.getFriendshipStatusRequest, new TargetedUserId { friendId = userId }, callback);
        }
        ...
        public void StartMatchmaking(string gameMode, ResultCallback<MatchmakingResponse> callback)
        {
            this.SendRequest(MessageType.startMatchmakingRequest,
                new StartMatchmakingRequest { gameMode = gameMode }, callback);
        }
        ...
        public void CancelMatchmaking(string gameMode, ResultCallback<MatchmakingResponse> callback)
        {
            this.SendRequest(MessageType.cancelMatchmakingRequest,
                new CancelMatchmakingRequest { gameMode = gameMode }, callback);
        }
