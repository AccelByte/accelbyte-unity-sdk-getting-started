...
namespace AccelByte.Api
{
    internal class AuthenticationApi
    {
        ...
        public IEnumerator<ITask> GetUserTokenWithRefreshToken(string clientId, string clientSecret, string refreshToken,
            ResultCallback<TokenData> callback)
        {
            ...
            var request =
                HttpRequestBuilder.CreatePost(this.baseUrl + "/iam/oauth/token")
                    .WithBasicAuth(clientId, clientSecret)
                    .WithContentType(MediaType.ApplicationForm)
                    .Accepts(MediaType.ApplicationJson)
            ...
            ResultCallback callback)
        {
            ...
            var request =
                HttpRequestBuilder.CreatePost(this.baseUrl + "/iam/oauth/revoke/token")
                    .WithBasicAuth(clientId, clientSecret)
                    .WithContentType(MediaType.ApplicationForm)
                    .Accepts(MediaType.ApplicationJson)
